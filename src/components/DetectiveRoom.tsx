...
import {
    ...
    bookMaterials, bookshelfMaterials,
    cardboardMaterials,
    cigarMaterials,
    clockMaterials,
    coatRackMaterials,
    ...
    return (
        <>
            ...
            <group onContextMenu={rcFocus(ANCHOR.binder3)} userData={{movable: true, anchorKey: 'binder3'}}>
                <Binder position={ANCHOR.binder3.position} rotation={ANCHOR.binder3.rotation}
                        materialsById={{
                            ...binderMaterials,
                        ...
                        paperFill={0.4} disableOutline inspectDisableOutline inspectPixelSize={3}
                />
            </group>

            <group onContextMenu={rcFocus(ANCHOR.binder4)} userData={{movable: true, anchorKey: 'binder4'}}>
                <Binder position={ANCHOR.binder4.position} rotation={ANCHOR.binder4.rotation}
                        materialsById={{
                            ...binderMaterials,
                            coverFront: {...binderMaterials.coverFront, color: '#1f5c3a'},
                            coverBack: {...binderMaterials.coverBack, color: '#1f5c3a'},
            ...
            <group onContextMenu={rcFocus(ANCHOR.binder5)} userData={{movable: true, anchorKey: 'binder5'}}>
                <Binder position={ANCHOR.binder5.position} rotation={ANCHOR.binder5.rotation}
                        materialsById={{
                            ...binderMaterials,
                            coverFront: {...binderMaterials.coverFront, color: '#1f5c3a'},
                            coverBack: {...binderMaterials.coverBack, color: '#1f5c3a'},
            ...
            <group onContextMenu={rcFocus(ANCHOR.binder6)} userData={{movable: true, anchorKey: 'binder6'}}>
                <Binder position={ANCHOR.binder6.position} rotation={ANCHOR.binder6.rotation}
                        materialsById={{
                            ...binderMaterials,
                            coverFront: {...binderMaterials.coverFront, color: '#1f5c3a'},
                            coverBack: {...binderMaterials.coverBack, color: '#1f5c3a'},
            ...
            <group onContextMenu={rcFocus(ANCHOR.binder7)} userData={{movable: true, anchorKey: 'binder7'}}>
                <Binder position={ANCHOR.binder7.position} rotation={ANCHOR.binder7.rotation}
                        materialsById={{
                            ...binderMaterials,
                            coverFront: {...binderMaterials.coverFront, color: '#1f5c3a'},
                            coverBack: {...binderMaterials.coverBack, color: '#1f5c3a'},
            ...
            <group onContextMenu={rcFocus(ANCHOR.binder8)} userData={{movable: true, anchorKey: 'binder8'}}>
                <Binder position={ANCHOR.binder8.position} rotation={ANCHOR.binder8.rotation}
                        materialsById={{
                            ...binderMaterials,
                            coverFront: {...binderMaterials.coverFront, color: '#1f5c3a'},
                            coverBack: {...binderMaterials.coverBack, color: '#1f5c3a'},
            ...
            <group onContextMenu={rcFocus(ANCHOR.binder9)} userData={{movable: true, anchorKey: 'binder9'}}>
                <Binder position={ANCHOR.binder9.position} rotation={ANCHOR.binder9.rotation}
                        materialsById={{
                            ...binderMaterials,
                            coverFront: {...binderMaterials.coverFront, color: '#1f5c3a'},
                            coverBack: {...binderMaterials.coverBack, color: '#1f5c3a'},
