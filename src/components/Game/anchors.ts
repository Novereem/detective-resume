...
export const ANCHOR: Record<AnchorKey, { eye: Vec3; position: Vec3; rotation?: Vec3 }> = {
    ...
    // Shelf 2
    bookshelf2: { eye: [-0.600, 1.600, 3.300], position: [-1.350, 0.000, 3.119], rotation: [0, Math.PI/2, 0] },

    book3: { eye: [0.200, 1.300, 3.600], position: [-1.319, 0.5, 3.721], rotation: [Math.PI/2, 0, Math.PI] },
    book4: { eye: [0.200, 1.300, 3.600], position: [-1.319, 0.5, 3.681], rotation: [Math.PI/2, 0, Math.PI] },
    book5: { eye: [0.200, 1.300, 3.600], position: [-1.319, 0.5, 3.641], rotation: [1.665, 0, Math.PI] },
    book6: { eye: [0.200, 1.300, 3.600], position: [-1.319, 0.47, 3.532], rotation: [2.506, 0, Math.PI] },
    book7: { eye: [0.200, 1.300, 3.600], position: [-1.319, 0.44, 3.389], rotation: [-0.266, 0, Math.PI] },

    binder1: { eye: [0.200, 1.300, 3.600], position: [-1.366, 0.061, 3.300], rotation: [Math.PI, 0, Math.PI] },
    binder2: { eye: [0.200, 1.300, 3.600], position: [-1.366, 0.121, 3.300], rotation: [Math.PI, 0, Math.PI] },

    binder6: { eye: [0.200, 1.300, 3.600], position: [-1.381, 0.191, 2.716], rotation: [-Math.PI/2, 0, -Math.PI] },
    binder7: { eye: [0.200, 1.300, 3.600], position: [-1.381, 0.191, 2.656], rotation: [-Math.PI/2, 0, -Math.PI] },
    binder8: { eye: [0.200, 1.300, 3.600], position: [-1.381, 0.191, 2.596], rotation: [-Math.PI/2, 0, -Math.PI] },
    binder9: { eye: [0.200, 1.300, 3.600], position: [-1.381, 0.191, 2.536], rotation: [-Math.PI/2, 0, -Math.PI] },
    ...
    mug: { eye: [-0.2, 1.3, 3.2], position: [-1.382, 0.710, 2.340] },
