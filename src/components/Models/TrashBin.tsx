...
export const TrashBin = memo(function TrashBin({
    ...
    const parts = useMemo<PartSpec[]>(() => {
        ...
        p.push({
            id: 'rimTop',
            geometry: <torusGeometry args={[Rt, rimT / 2, 16, 128]} />,
        ...
        p.push({
            id: 'rimBottom',
            geometry: <torusGeometry args={[Rb, rimT / 2, 16, 128]} />,
            rotation: [Math.PI / 2, 0, 0],
            position: [0, -H / 2 + rimT / 2, 0],
        ...
        const steps = Math.max(100, Math.round(turns * stepsPerTurn))
        ...
        const count = Math.max(1, Math.floor(spiralCountPerDir))
        ...
        p.push({
            id: 'base',
            geometry: <cylinderGeometry args={[baseR + 0.01, baseR + 0.01, baseT, 48, 1, false]} />,
        ...
        Rt, Rb, H, rimT, baseT, baseInset,
        spiralAngleDeg, ribbonW, ribbonT, spiralCountPerDir, stepsPerTurn,
        color, outlineColor
    ])
